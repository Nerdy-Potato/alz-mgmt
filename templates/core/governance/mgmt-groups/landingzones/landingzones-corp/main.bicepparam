  ...
  'Deploy-Private-DNS-Zones': {
    ...
    parameters: {
      ...
      azureAcrPrivateDnsZoneId: {
        value: '/subscriptions//resourceGroups/rg-alz-dns-${parLocations[0]}/providers/Microsoft.Network/privateDnsZones/privatelink.azurecr.io'
      }
      // Azure App Service private DNS zone
      azureAppPrivateDnsZoneId: {
        value: '/subscriptions//resourceGroups/rg-alz-dns-${parLocations[0]}/providers/Microsoft.Network/privateDnsZones/privatelink.azurewebsites.net'
      }
      ...
      azureArcGuestconfigurationPrivateDnsZoneId: {
        value: '/subscriptions//resourceGroups/rg-alz-dns-${parLocations[0]}/providers/Microsoft.Network/privateDnsZones/privatelink.guestconfiguration.azure.com'
      }
      // Azure Arc Hybrid Resource Provider private DNS zone
      azureArcHybridResourceProviderPrivateDnsZoneId: {
        value: '/subscriptions//resourceGroups/rg-alz-dns-${parLocations[0]}/providers/Microsoft.Network/privateDnsZones/privatelink.his.arc.azure.com'
      }
      // Azure Arc Kubernetes Configuration private DNS zone
      azureArcKubernetesConfigurationPrivateDnsZoneId: {
        value: '/subscriptions//resourceGroups/rg-alz-dns-${parLocations[0]}/providers/Microsoft.Network/privateDnsZones/privatelink.dp.kubernetesconfiguration.azure.com'
      }
      // Azure Site Recovery private DNS zone
      azureAsrPrivateDnsZoneId: {
        value: '/subscriptions//resourceGroups/rg-alz-dns-${parLocations[0]}/providers/Microsoft.Network/privateDnsZones/privatelink.siterecovery.windowsazure.com'
      }
      // Azure Automation DSC Hybrid private DNS zone
      azureAutomationDSCHybridPrivateDnsZoneId: {
        value: '/subscriptions//resourceGroups/rg-alz-dns-${parLocations[0]}/providers/Microsoft.Network/privateDnsZones/privatelink.azure-automation.net'
      }
      ...
      azureBatchPrivateDnsZoneId: {
        value: '/subscriptions//resourceGroups/rg-alz-dns-${parLocations[0]}/providers/Microsoft.Network/privateDnsZones/privatelink.batch.azure.com'
      }
      // Azure Bot Service private DNS zone
      azureBotServicePrivateDnsZoneId: {
        value: '/subscriptions//resourceGroups/rg-alz-dns-${parLocations[0]}/providers/Microsoft.Network/privateDnsZones/privatelink.directline.botframework.com'
      }
      // Azure Cognitive Search private DNS zone
      azureCognitiveSearchPrivateDnsZoneId: {
        value: '/subscriptions//resourceGroups/rg-alz-dns-${parLocations[0]}/providers/Microsoft.Network/privateDnsZones/privatelink.search.windows.net'
      }
      // Azure Cognitive Services private DNS zone
      azureCognitiveServicesPrivateDnsZoneId: {
        value: '/subscriptions//resourceGroups/rg-alz-dns-${parLocations[0]}/providers/Microsoft.Network/privateDnsZones/privatelink.cognitiveservices.azure.com'
      }
      // Azure Cosmos DB Cassandra private DNS zone
      azureCosmosCassandraPrivateDnsZoneId: {
        value: '/subscriptions//resourceGroups/rg-alz-dns-${parLocations[0]}/providers/Microsoft.Network/privateDnsZones/privatelink.cassandra.cosmos.azure.com'
      }
      // Azure Cosmos DB Gremlin private DNS zone
      azureCosmosGremlinPrivateDnsZoneId: {
        value: '/subscriptions//resourceGroups/rg-alz-dns-${parLocations[0]}/providers/Microsoft.Network/privateDnsZones/privatelink.gremlin.cosmos.azure.com'
      }
      // Azure Cosmos DB MongoDB private DNS zone
      azureCosmosMongoPrivateDnsZoneId: {
        value: '/subscriptions//resourceGroups/rg-alz-dns-${parLocations[0]}/providers/Microsoft.Network/privateDnsZones/privatelink.mongo.cosmos.azure.com'
      }
      // Azure Cosmos DB SQL API private DNS zone
      azureCosmosSQLPrivateDnsZoneId: {
        value: '/subscriptions//resourceGroups/rg-alz-dns-${parLocations[0]}/providers/Microsoft.Network/privateDnsZones/privatelink.documents.azure.com'
      }
      // Azure Cosmos DB Table private DNS zone
      azureCosmosTablePrivateDnsZoneId: {
        value: '/subscriptions//resourceGroups/rg-alz-dns-${parLocations[0]}/providers/Microsoft.Network/privateDnsZones/privatelink.table.cosmos.azure.com'
      }
      // Azure Data Factory portal private DNS zone
      azureDataFactoryPortalPrivateDnsZoneId: {
        value: '/subscriptions//resourceGroups/rg-alz-dns-${parLocations[0]}/providers/Microsoft.Network/privateDnsZones/privatelink.adf.azure.com'
      }
      // Azure Data Factory private DNS zone
      azureDataFactoryPrivateDnsZoneId: {
        value: '/subscriptions//resourceGroups/rg-alz-dns-${parLocations[0]}/providers/Microsoft.Network/privateDnsZones/privatelink.datafactory.azure.net'
      }
      // Azure Databricks private DNS zone
      azureDatabricksPrivateDnsZoneId: {
        value: '/subscriptions//resourceGroups/rg-alz-dns-${parLocations[0]}/providers/Microsoft.Network/privateDnsZones/privatelink.azuredatabricks.net'
      }
      // Azure Disk Access private DNS zone
      azureDiskAccessPrivateDnsZoneId: {
        value: '/subscriptions//resourceGroups/rg-alz-dns-${parLocations[0]}/providers/Microsoft.Network/privateDnsZones/privatelink.blob.core.windows.net'
      }
      // Azure Event Grid domains private DNS zone
      azureEventGridDomainsPrivateDnsZoneId: {
        value: '/subscriptions//resourceGroups/rg-alz-dns-${parLocations[0]}/providers/Microsoft.Network/privateDnsZones/privatelink.eventgrid.azure.net'
      }
      ...
      azureEventHubNamespacePrivateDnsZoneId: {
        value: '/subscriptions//resourceGroups/rg-alz-dns-${parLocations[0]}/providers/Microsoft.Network/privateDnsZones/privatelink.servicebus.windows.net'
      }
      // Azure File private DNS zone
      azureFilePrivateDnsZoneId: {
        value: '/subscriptions//resourceGroups/rg-alz-dns-${parLocations[0]}/providers/Microsoft.Network/privateDnsZones/privatelink.afs.azure.net'
      }
      // Azure HDInsight private DNS zone
      azureHDInsightPrivateDnsZoneId: {
        value: '/subscriptions//resourceGroups/rg-alz-dns-${parLocations[0]}/providers/Microsoft.Network/privateDnsZones/privatelink.azurehdinsight.net'
      }
      // Azure IoT Central private DNS zone
      azureIotCentralPrivateDnsZoneId: {
        value: '/subscriptions//resourceGroups/rg-alz-dns-${parLocations[0]}/providers/Microsoft.Network/privateDnsZones/privatelink.azureiotcentral.com'
      }
      // Azure IoT Device Update private DNS zone
      azureIotDeviceupdatePrivateDnsZoneId: {
        value: '/subscriptions//resourceGroups/rg-alz-dns-${parLocations[0]}/providers/Microsoft.Network/privateDnsZones/privatelink.api.adu.microsoft.com'
      }
      // Azure IoT Hubs private DNS zone
      azureIotHubsPrivateDnsZoneId: {
        value: '/subscriptions//resourceGroups/rg-alz-dns-${parLocations[0]}/providers/Microsoft.Network/privateDnsZones/privatelink.azure-devices.net'
      }
      // Azure IoT private DNS zone
      azureIotPrivateDnsZoneId: {
        value: '/subscriptions//resourceGroups/rg-alz-dns-${parLocations[0]}/providers/Microsoft.Network/privateDnsZones/privatelink.azure-devices-provisioning.net'
      }
      // Azure Key Vault private DNS zone
      azureKeyVaultPrivateDnsZoneId: {
        value: '/subscriptions//resourceGroups/rg-alz-dns-${parLocations[0]}/providers/Microsoft.Network/privateDnsZones/privatelink.vaultcore.azure.net'
      }
      // Azure Machine Learning workspace private DNS zone
      azureMachineLearningWorkspacePrivateDnsZoneId: {
        value: '/subscriptions//resourceGroups/rg-alz-dns-${parLocations[0]}/providers/Microsoft.Network/privateDnsZones/privatelink.api.azureml.ms'
      }
      // Azure Machine Learning workspace second private DNS zone
      azureMachineLearningWorkspaceSecondPrivateDnsZoneId: {
        value: '/subscriptions//resourceGroups/rg-alz-dns-${parLocations[0]}/providers/Microsoft.Network/privateDnsZones/privatelink.notebooks.azure.net'
      }
      // Azure Managed Grafana workspace private DNS zone
      azureManagedGrafanaWorkspacePrivateDnsZoneId: {
        value: '/subscriptions//resourceGroups/rg-alz-dns-${parLocations[0]}/providers/Microsoft.Network/privateDnsZones/privatelink.grafana.azure.com'
      }
      // Azure Media Services key private DNS zone
      azureMediaServicesKeyPrivateDnsZoneId: {
        value: '/subscriptions//resourceGroups/rg-alz-dns-${parLocations[0]}/providers/Microsoft.Network/privateDnsZones/privatelink.media.azure.net'
      }
      ...
      azureMigratePrivateDnsZoneId: {
        value: '/subscriptions//resourceGroups/rg-alz-dns-${parLocations[0]}/providers/Microsoft.Network/privateDnsZones/privatelink.prod.migration.windowsazure.com'
      }
      // Azure Monitor private DNS zone 1
      azureMonitorPrivateDnsZoneId1: {
        value: '/subscriptions//resourceGroups/rg-alz-dns-${parLocations[0]}/providers/Microsoft.Network/privateDnsZones/privatelink.monitor.azure.com'
      }
      // Azure Monitor private DNS zone 2
      azureMonitorPrivateDnsZoneId2: {
        value: '/subscriptions//resourceGroups/rg-alz-dns-${parLocations[0]}/providers/Microsoft.Network/privateDnsZones/privatelink.oms.opinsights.azure.com'
      }
      // Azure Monitor private DNS zone 3
      azureMonitorPrivateDnsZoneId3: {
        value: '/subscriptions//resourceGroups/rg-alz-dns-${parLocations[0]}/providers/Microsoft.Network/privateDnsZones/privatelink.ods.opinsights.azure.com'
      }
      // Azure Monitor private DNS zone 4
      azureMonitorPrivateDnsZoneId4: {
        value: '/subscriptions//resourceGroups/rg-alz-dns-${parLocations[0]}/providers/Microsoft.Network/privateDnsZones/privatelink.agentsvc.azure-automation.net'
      }
      ...
      azureRedisCachePrivateDnsZoneId: {
        value: '/subscriptions//resourceGroups/rg-alz-dns-${parLocations[0]}/providers/Microsoft.Network/privateDnsZones/privatelink.redis.cache.windows.net'
      }
      ...
      azureSignalRPrivateDnsZoneId: {
        value: '/subscriptions//resourceGroups/rg-alz-dns-${parLocations[0]}/providers/Microsoft.Network/privateDnsZones/privatelink.service.signalr.net'
      }
      // Azure Site Recovery backup private DNS zone
      azureSiteRecoveryBackupPrivateDnsZoneId: {
        value: '/subscriptions//resourceGroups/rg-alz-dns-${parLocations[0]}/providers/Microsoft.Network/privateDnsZones/privatelink.{regionCode}.backup.windowsazure.com'
      }
      ...
      azureSiteRecoveryQueuePrivateDnsZoneId: {
        value: '/subscriptions//resourceGroups/rg-alz-dns-${parLocations[0]}/providers/Microsoft.Network/privateDnsZones/privatelink.queue.core.windows.net'
      }
      ...
      azureStorageDFSPrivateDnsZoneId: {
        value: '/subscriptions//resourceGroups/rg-alz-dns-${parLocations[0]}/providers/Microsoft.Network/privateDnsZones/privatelink.dfs.core.windows.net'
      }
      ...
      azureStorageFilePrivateDnsZoneId: {
        value: '/subscriptions//resourceGroups/rg-alz-dns-${parLocations[0]}/providers/Microsoft.Network/privateDnsZones/privatelink.file.core.windows.net'
      }
      ...
      azureStorageStaticWebPrivateDnsZoneId: {
        value: '/subscriptions//resourceGroups/rg-alz-dns-${parLocations[0]}/providers/Microsoft.Network/privateDnsZones/privatelink.web.core.windows.net'
      }
      ...
      azureStorageTablePrivateDnsZoneId: {
        value: '/subscriptions//resourceGroups/rg-alz-dns-${parLocations[0]}/providers/Microsoft.Network/privateDnsZones/privatelink.table.core.windows.net'
      }
      ...
      azureSynapseDevPrivateDnsZoneId: {
        value: '/subscriptions//resourceGroups/rg-alz-dns-${parLocations[0]}/providers/Microsoft.Network/privateDnsZones/privatelink.dev.azuresynapse.net'
      }
      // Azure Synapse Analytics SQL private DNS zone
      azureSynapseSQLPrivateDnsZoneId: {
        value: '/subscriptions//resourceGroups/rg-alz-dns-${parLocations[0]}/providers/Microsoft.Network/privateDnsZones/privatelink.sql.azuresynapse.net'
      }
      ...
      azureVirtualDesktopHostpoolPrivateDnsZoneId: {
        value: '/subscriptions//resourceGroups/rg-alz-dns-${parLocations[0]}/providers/Microsoft.Network/privateDnsZones/privatelink.wvd.microsoft.com'
      }
